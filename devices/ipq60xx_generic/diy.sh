...
rm -rf package/libs feeds/kiddin9/{rtl*,nft-fullcone,shortcut-fe,fullconenat} package/kernel/mt76 toolchain/musl package/feeds/packages/{jool,xtables-addons,openvswitch}
